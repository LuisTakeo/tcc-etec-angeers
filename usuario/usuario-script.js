...
function validatePassword(password)
{
    ...
    if (hasDigits(password) && hasMaxLetters(password) && hasMinLetters(password))
        return true;
    console.log("Insira pelo menos uma letra maiuscula, uma minuscula e um número")
    // alert("Insira pelo menos uma letra maiuscula, uma minuscula e um número")
    msgError.textContent = "Insira pelo menos uma letra maiuscula, uma minuscula e um número"
    return false;
}
